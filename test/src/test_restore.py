...
class TestLoadYamlFile:
    ...
    def test_load_valid_yaml_file(self, tmp_path):
        ...
        yaml_content = {
            "apiVersion": "v1",
            "kind": "ConfigMap",
            "metadata": {"name": "test-config", "namespace": "test-ns"},
        }
...
class TestRestoreResource:
    ...
    def test_create_new_cluster_resource(self):
        ...
        assert status is None
        self.mock_resource_api.create.assert_called_once_with(body=resource_data)
    ...
    def test_namespace_override(self):
        ...
        resource_data = {
            "apiVersion": "v1",
            "kind": "ConfigMap",
            "metadata": {"name": "test-config", "namespace": "original-ns"},
        }
    ...
    def test_missing_kind_field(self):
        ...
        resource_data = {"apiVersion": "v1", "metadata": {"name": "test-resource"}}
    ...
    def test_missing_api_version_field(self):
        ...
        resource_data = {"kind": "ConfigMap", "metadata": {"name": "test-resource"}}
    ...
    def test_missing_name_field(self):
        ...
        resource_data = {"apiVersion": "v1", "kind": "ConfigMap", "metadata": {}}
